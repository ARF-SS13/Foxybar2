...
#define PREFDAT_COLKEY_GEAR           "PREFDAT_COLKEY_GEAR"
#define PREFDAT_COLKEY_MARKING        "PREFDAT_COLKEY_MARKING"
...
#define PPT_CHARCTER_PROPERTIES                               "PPT_CHARCTER_PROPERTIES"
	#define PPT_CHARCTER_PROPERTIES_INFO                          "PPT_CHARCTER_PROPERTIES_INFO"
	#define PPT_CHARCTER_PROPERTIES_VOICE                         "PPT_CHARCTER_PROPERTIES_VOICE"
	#define PPT_CHARCTER_PROPERTIES_MISC                          "PPT_CHARCTER_PROPERTIES_MISC"
#define PPT_CHARCTER_APPEARANCE                               "PPT_CHARCTER_APPEARANCE"
	#define PPT_CHARCTER_APPEARANCE_MISC                          "PPT_CHARCTER_APPEARANCE_MISC"
	#define PPT_CHARCTER_APPEARANCE_HAIR_EYES                     "PPT_CHARCTER_APPEARANCE_HAIR_EYES"
	#define PPT_CHARCTER_APPEARANCE_PARTS                         "PPT_CHARCTER_APPEARANCE_PARTS"
	#define PPT_CHARCTER_APPEARANCE_MARKINGS                      "PPT_CHARCTER_APPEARANCE_MARKINGS"
	#define PPT_CHARCTER_APPEARANCE_UNDERLYING                    "PPT_CHARCTER_APPEARANCE_UNDERLYING"
		#define PPT_CHARCTER_APPEARANCE_UNDERLYING_UNDIES             "PPT_CHARCTER_APPEARANCE_UNDERLYING_UNDIES"
		#define PPT_CHARCTER_APPEARANCE_UNDERLYING_LAYERING           "PPT_CHARCTER_APPEARANCE_UNDERLYING_LAYERING"
#define PPT_LOADOUT                                           "PPT_LOADOUT"
#define PPT_GAME_PREFERENCES                                  "PPT_GAME_PREFERENCES"
	#define PPT_GAME_PREFERENCES_GENERAL                          "PPT_GAME_PREFERENCES_GENERAL"
	#define PPT_GAME_PREFERENCES_UI                               "PPT_GAME_PREFERENCES_UI"
	#define PPT_GAME_PREFERENCES_CHAT                             "PPT_GAME_PREFERENCES_CHAT"
	#define PPT_GAME_PREFERENCES_RUNECHAT                         "PPT_GAME_PREFERENCES_RUNECHAT"
	#define PPT_GAME_PREFERENCES_GHOST                            "PPT_GAME_PREFERENCES_GHOST"
	#define PPT_GAME_PREFERENCES_AUDIO                            "PPT_GAME_PREFERENCES_AUDIO"
	#define PPT_GAME_PREFERENCES_ADMIN                            "PPT_GAME_PREFERENCES_ADMIN"
